...
function SignUp() {
  ...
  return (
    <div className='bg-amber-200 w-[500px] p-4 flex flex-col justify-center items-center rounded-md shadow-4xl-white '>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-1 mt-4 text-center'>
        ...
        <button type="submit" className='bg-blue-500 shadow-4xs text-white'>Sign Up</button>
      </form>
